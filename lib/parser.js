  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "adtType": parse_adtType,
        "typeLiteral": parse_typeLiteral,
        "captureLiteral": parse_captureLiteral,
        ...
        "capturePatterns": parse_capturePatterns,
        "arrayRestPatterns": parse_arrayRestPatterns,
        "restOrRestIdentifierLiteral": parse_restOrRestIdentifierLiteral,
        "restIdentifierLiteral": parse_restIdentifierLiteral,
        "restLiteral": parse_restLiteral,
        "jsIdentifierLiteral": parse_jsIdentifierLiteral,
        "jsIdentifier": parse_jsIdentifier,
        "identifier": parse_identifier,
        "rest": parse_rest,
        "string": parse_string,
        "doubleStringChars": parse_doubleStringChars,
        "singleStringChars": parse_singleStringChars,
                        ...
                        if (result0 === null) {
                          ...
                          if (result0 === null) {
                            ...
                            if (result0 === null) {
                              ...
                              if (result0 === null) {
                                result0 = parse_adtType();
                                if (result0 === null) {
                                  result0 = parse_typeLiteral();
                                  if (result0 === null) {
                                    result0 = parse_captureLiteral();
                                    if (result0 === null) {
      ...
      function parse_adtType() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, type, patterns) {
              return {
      ...
      function parse_capturePatterns() {
        var result0;
      ...
      function parse_arrayRestPatterns() {
        ...
        pos0 = pos;
        pos1 = pos;
        result0 = parse_restOrRestIdentifierLiteral();
        if (result0 === null) {
          result0 = parse_pattern();
        }
        if (result0 !== null) {
          ...
          if (result2 !== null) {
            ...
            if (result3 !== null) {
              result4 = parse__();
              if (result4 !== null) {
                result5 = parse_restOrRestIdentifierLiteral();
                if (result5 === null) {
                  result5 = parse_pattern();
                }
                if (result5 !== null) {
      ...
      function parse_restOrRestIdentifierLiteral() {
        var result0;
        
        result0 = parse_restLiteral();
        if (result0 === null) {
          result0 = parse_restIdentifierLiteral();
        }
        return result0;
      }
      
      function parse_restIdentifierLiteral() {
        var result0, result1;
        var pos0, pos1;
      ...
      function parse_jsIdentifierLiteral() {
        var result0;
        var pos0;
      ...
      function parse_string() {
        ...
        if (result0 !== null) {
          result1 = parse_doubleStringChars();
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result1 = parse_singleStringChars();
            result1 = result1 !== null ? result1 : "";
            if (result1 !== null) {
              if (input.charCodeAt(pos) === 39) {
                result2 = "'";
      ...
      function parse_doubleStringChars() {
        var result0, result1;
        var pos0;
        
        pos0 = pos;
        result1 = parse_doubleStringChar();
        if (result1 !== null) {
          result0 = [];
          while (result1 !== null) {
      ...
      function parse_singleStringChars() {
        var result0, result1;
        var pos0;
        
        pos0 = pos;
        result1 = parse_singleStringChar();
        if (result1 !== null) {
          result0 = [];
          while (result1 !== null) {
            result0.push(result1);
